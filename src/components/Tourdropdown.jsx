...
const Tourdropdown = () => {
  return (
    <div>
      {" "}
      <div className="text-gray-300 cursor-pointer  transition-none  shadow-sm fixed top-[180px] left-[690px]  w-[15%] p-[30px] bg-[#1f1f1f] opacity-100 z-[50000] flex   flex-col gap-4">
